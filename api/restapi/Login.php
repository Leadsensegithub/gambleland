...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($data['adv_company_name']) && isset($data['adv_email']) && isset($data['adv_monthly_budget']) && isset($data['adv_name']) && isset($data['adv_password']) && isset($data['adv_phone']) && isset($data['adv_website']) && isset($data['know_us']) && isset($data['social_media']) && isset($data['status'])) {
